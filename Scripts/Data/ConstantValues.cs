...
{
    public static readonly byte TileSize = 64;
    ...
    public static readonly byte TileNumX = (byte)(TileContainerWidth / TileSize + 2);
    public static readonly byte TileNumY = (byte)(TileContainerHeight / TileSize + 2);
}
